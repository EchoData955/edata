...
<?php $__env->startSection('title', __('messages.cases')); ?>
...
<section class="max-w-7xl mx-auto px-4 py-12">
  <header class="mb-8 text-center md:text-start">
    ...
    <p class="text-gray-600 mt-2">
      <?php echo e(__('messages.cases_intro')); ?>
  ...
  <div class="grid md:grid-cols-3 gap-6">
    <?php $__currentLoopData = $cases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <article class="bg-white rounded-2xl overflow-hidden border transition hover:shadow-md hover:-translate-y-0.5 hover:border-[#1EA8A8]">
        <img src="<?php echo e($c['img']); ?>" alt="" class="w-full h-44 object-cover" loading="lazy" decoding="async">
        <div class="p-4">
          <h3 class="font-bold mb-1 text-[#1EA8A8]"><?php echo e(__('messages.'.$c['t'])); ?></h3>
          <p class="text-sm text-gray-600 leading-relaxed"><?php echo e(__('messages.'.$c['d'])); ?></p>
        </div>
      </article>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\projects\EData\Website\edata\resources\views/pages/cases.blade.php ENDPATH**/ ?>